...
public class SanPhamYT_Adapter extends RecyclerView.Adapter<SanPhamYT_Adapter.ViewHodel>  {
    private Context context;
    private ArrayList<SanPhamModel> list;
    private SanPhamYT_Dao dao;
    ThongBaoDao daotb;
    public SanPhamYT_Adapter(Context context, ArrayList<SanPhamModel> list, SanPhamYT_Dao dao) {
        this.context = context;
        this.list = list;
        this.dao = dao;
        this.daotb = new ThongBaoDao(context);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHodel holder,  @SuppressLint("RecyclerView") int position) {
        ...
        holder.txtxoa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String tb = "Bạn đã xóa sản phẩm " + mota + " ra khỏi danh sách yêu thích";
